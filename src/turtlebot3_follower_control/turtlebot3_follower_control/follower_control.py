...
class SimpleFollowerControl(Node):
    def __init__(self):
        ...
        # self.K_p_linear = 0.3
        # self.K_d_linear = 2.0 * math.sqrt(1.0 * self.K_p_linear)  # M=1.0
        # self.K_i_linear = 0.03  # Small integral term

        # self.K_p_angular = 0.2
    ...
    def control_loop(self):
        ...
        # now
        cmd.angular.z = self.K_p_angular*heading_error + self.K_d_angular*(heading_error - self.prev_heading_error) + self.K_i_angular*self.heading_integral
        ...
        if abs(heading_error) < 0.8:  # ~45 degrees
            ...
            # now
            cmd.linear.x = self.K_p_linear * distance_error + self.K_d_linear * (distance_error - self.prev_distance_error) + self.K_i_linear*self.distance_integral
